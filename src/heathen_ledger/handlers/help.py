...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    help_text = (
        ...
        "• `/close` — Close the ledger and have the bot leave the group once all debts are settled.\n\n"
        ...
        "🧾 **Receipt & Ticket Scanning**\n"
        "• Reply to any receipt or ticket photo with `/ticket`, send a photo with caption `/ticket`, or tag the bot to parse items and totals.\n"
        "• In private 1-on-1 chat with the bot, simply send a receipt photo to scan it automatically.\n\n"
